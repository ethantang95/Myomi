...
namespace Myomi.Data
{
    ...
    public class PoseProfileData : IProfileData
    {
        public Pose Pose { get; set; }
        public bool Enabled { get; set; }
    }
    //data obtained from the acceleronmeter
    public class AccelerationProfileData : IProfileData
    {
    ...
    public class GyroscopeProfileData : IProfileData
    {
        public int X { get; set; }
        public int Y { get; set; }
        public int Z { get; set; }
    ...
    public class OrientationProfileData : IProfileData
    {
